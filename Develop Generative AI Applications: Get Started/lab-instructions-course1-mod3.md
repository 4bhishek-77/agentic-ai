...
Here's a list of some of the latest models available in WatsonX (as of September 15, 2025). Just replace the model\_id in the code with one of the ones below and run the program again!
